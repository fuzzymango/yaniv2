 ...
 * `exp` (docs/adr/0020). `createSocketServer`'s default verifier, as real time is its
 * default clock: production composes it by composing the server, and a test that signs in
 * passes a fake instead.
 *

...
export function SettingsDialog({ settings }: { settings: RoomSettings }) {
  ...
  return (
    <>
      ...
      {open && (
        // One tap in, and three ways out of it — the backdrop, the control below, and
        // Escape. All three are the panel's own doing; see `Modal.tsx`.
        <Modal title={SETTINGS_TITLE} onDismiss={() => setOpen(false)}>
